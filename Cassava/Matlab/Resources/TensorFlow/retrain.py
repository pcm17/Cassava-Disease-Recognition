...
def main(_):
  ...
  results=open(img_dir + ' results file.txt', 'a')
  results.write('%.2f\t%.3f\t%d\t%d\n' % ((test_accuracy*100),lr,tr_batch_size,test_percentage))
  ...
  np.savetxt("plantvillage/cassava/matlab/resources/leaflet/labels_predictions/"+str(test_percentage)+"/labels.csv", a, delimiter=",")
  
  a = np.asarray(predictions)
  np.savetxt("plantvillage/cassava/matlab/resources/leaflet/labels_predictions/"+str(test_percentage)+"/predictions.csv", a, delimiter=",")
