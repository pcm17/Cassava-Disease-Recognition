...
def create_image_lists(image_dir, testing_percentage, validation_percentage, small_class_label, n_images_small_class, num_images_for_large_classes):
  ...
  is_root_dir = True
  print('num images in small class = ', n_images_small_class)
  for sub_dir in sub_dirs:
    ...
    # Randomly shuffle files in order to get a true random subset of images  
    shuffle(file_list)
    ...
    for file_name in file_list:
      ...
      #print('Percentage Hash = ', percentage_hash)
      if dir_name == small_class_label and N < n_images_small_class:
        #print(base_name + " included in small class: " + small_class_label)
        N=N+1
      ...
      elif dir_name != small_class_label and M < num_images_for_large_classes:
        M=M+1
        if percentage_hash < validation_percentage:
          validation_images.append(base_name)
        elif percentage_hash < (testing_percentage + validation_percentage):
...
def main(_):
  ...
  image_lists = create_image_lists(FLAGS.image_dir, FLAGS.testing_percentage,
                                   FLAGS.validation_percentage, FLAGS.small_class_label, FLAGS.num_images_for_small_class, FLAGS.num_images_for_large_classes)
  class_count = len(image_lists.keys())
  if class_count == 0:
  ...
  with tf.Session(graph=graph) as sess:
    ...
    # Save weights
    saver.save(sess, FLAGS.summaries_dir + "_trained_weights")
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--image_dir',
      type=str,
      default='/Users/dph14/Desktop/Pete_Cassava/ModelData/11.30.2017/Images',
      #default='/Volumes/PeteCassava/CassavaGoogle10.26.2017/Images',
  ...
  parser.add_argument(
      '--bottleneck_dir',
      type=str,
      default='/Users/dph14/Desktop/bottleneck',
